...
public class GlobalExceptionHandler
{
	...
	public ResponseEntity <ResponseStructure <String>> handleNoSessionFound (NoSessionFound e)
	{
		logger.warn ("No session found: {} (Code: {})", e.getMessage (), e.getErrorCode ().getCode ());
