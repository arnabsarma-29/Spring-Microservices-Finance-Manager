...
import com.finance_manager.budget_service.exception.BudgetNotFoundException;
import com.finance_manager.budget_service.exception.BudgetSaveException;
...
public class BudgetServiceImplementation implements BudgetService
{
	...
	public void save (BudgetModel budgetModel)
	{
		...
		{
			throw new BudgetSaveException ("Failed to save budget!", e);
		}
	}
	@Override
	...
	{
		return budgetMapper.toBudgetDTO (budgetDAO.getBudget (userClient.getId ()).orElseThrow (() -> new BudgetNotFoundException ("Budget not found")));
	}
}